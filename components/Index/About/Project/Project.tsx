                ...
                <ul className={style.ProjectList}>
                    <li className={style.ProjectItem}>
                        <div className={style.ProjectItemImage}>
                            <Image style={{ width: '100%', height: 'auto' }} src="/image/project1.webp" width={130} height={130} alt="Картинка" />
                        </div>
                    ...
                    <li className={style.ProjectItem}>
                        <div className={style.ProjectItemImage}>
                            <Image style={{ width: '100%', height: 'auto' }} src="/image/project2.webp" width={130} height={130} alt="Картинка" />
                        </div>
                    ...
                    <li className={style.ProjectItem}>
                        <div className={style.ProjectItemImage}>
                            <Image style={{ width: '100%', height: 'auto' }} src="/image/project3.webp" width={130} height={130} alt="Картинка" />
                        </div>
